...
public class LocationServiceProxy implements LocationService, LocationServiceInfo {
    ...
    public void configure(Config config) {
        ...
        // FIXES:
        // https://github.com/ivanmihov/react-native-background-geolocation/issues/360
        // https://github.com/ivanmihov/cordova-plugin-background-geolocation/issues/551
        // https://github.com/ivanmihov/cordova-plugin-background-geolocation/issues/552
        if (!isStarted()) { return; }
