// Type definitions for cordova-plugin-ivanmihov-background-geolocation.
// Project: https://github.com/ivanmihov/cordova-plugin-background-geolocation
// Definitions by: ivanmihov (@ivanmihov), Norbert Györög (@djereg)
// Definitions: https://github.com/ivanmihov/cordova-plugin-background-geolocation/blob/master/www/BackgroundGeolocation.d.ts
...
export interface BackgroundGeolocationPlugin {
   ...
   * @param success
   * @param fail
   * @see {@link https://github.com/ivanmihov/react-native-background-geolocation#getlocationssuccess-fail|Docs}
   */
  getLocations(
   ...
   * @param success
   * @param fail
   * @see {@link https://github.com/ivanmihov/react-native-background-geolocation#getvalidlocationssuccess-fail|Docs}
   */
  getValidLocations(
    success: (location: Location[]) => void,
    fail?: (error: BackgroundGeolocationError) => void
