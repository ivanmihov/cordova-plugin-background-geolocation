...
More info: https://github.com/ivanmihov/react-native-background-geolocation/pull/269
- Allow stopping location updates on status "285 Updates Not Required" (by [@danielgindi](https://github.com/danielgindi/))
More info: https://github.com/ivanmihov/react-native-background-geolocation/pull/271

Since alpha.45:
- Listen for 401 Unauthorized status codes received from http server (by [@FeNoMeNa](https://github.com/FeNoMeNa/))
More info: https://github.com/ivanmihov/react-native-background-geolocation/pull/308/files
...
https://github.com/ivanmihov/background-geolocation-android/pull/4 by @grassick
...
(PR: [#9](https://github.com/ivanmihov/background-geolocation-android/pull/9)
...
Since alpha.38:
- iOS Fix crash on delete all location ([7392e39](https://github.com/ivanmihov/background-geolocation-ios/commit/7392e391c3de3ff0d6f5ef2ef19c34aba612bf9b) by [@acerbetti](https://github.com/acerbetti/))

Since alpha.39:
- Android Defer start and configure until service is ready
(PR: [#7](https://github.com/ivanmihov/background-geolocation-android/pull/7)
Commit: [00e1314](https://github.com/ivanmihov/background-geolocation-android/commit/00e131478ad4e37576eb85581bb663b65302a4e0) by [@danielgindi](https://github.com/danielgindi/),
fixes #201, #181, #172)

Since alpha.40:
- iOS Avoid taking control of UNUserNotificationCenter
(PR: [#268](https://github.com/ivanmihov/react-native-background-geolocation/pull/268))

Since alpha.42:
- Android fix locationService treating success as errors
(PR: [#13](https://github.com/ivanmihov/background-geolocation-android/pull/13)
by [@hoisel](https://github.com/hoisel/))

Since alpha.43:
- Android make sure mService exists when we call start or stop
(PR: [#17](https://github.com/ivanmihov/background-geolocation-android/pull/17)
